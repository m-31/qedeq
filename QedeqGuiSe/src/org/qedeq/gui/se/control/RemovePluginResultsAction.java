...
/**
 * Remove plugin results for selected modules.
 */
class RemovePluginResultsAction extends AbstractAction {

    /** This class. */
    private static final Class CLASS = RemovePluginResultsAction.class;
     ...
     */
    RemovePluginResultsAction(final QedeqController controller) {
