% -*- TeX:DE -*-
%%% ====================================================================
%%% @LaTeX-file    qedeq_sample3
%%% Generated from http://www.qedeq.org/0_04_07/doc/sample/qedeq_sample3.xml
%%% Generated at   2013-05-20 16:27:23.040
%%% ====================================================================
...
\begin{rul}[MISSING! OTHER: Modus Ponens\index{Modus Ponens}]
...
\label{proposition:four!7} \hypertarget{proposition:four!7}{\mbox{(7)}}  \ &  \ $(\forall x\ \phi(x)\ \rightarrow\ \phi(y))\ \rightarrow\ (\forall x\ \phi(x)\ \rightarrow\ \exists x\ \phi(x))$ \ &  \ {\tiny \hyperlink{rule:modusPonens}{MP} \hyperlink{proposition:four!6}{(6)}, \hyperlink{proposition:four!2}{(2)}} \\ 
\label{proposition:four!8} \hypertarget{proposition:four!8}{\mbox{(8)}}  \ &  \ $\forall x\ \phi(x)\ \rightarrow\ \exists x\ \phi(x)$ \ &  \ {\tiny \hyperlink{rule:modusPonens}{MP} \hyperlink{proposition:four!7}{(7)}, \hyperlink{proposition:four!1}{(1)}} \\ 
 & & \qedhere
\end{longtable}
\end{proof}
...
\label{proposition:five!18} \hypertarget{proposition:five!18}{\mbox{(18)}}  \ &  \ $\exists x\ \forall y\ \phi(x, y)\ \rightarrow\ \forall y\ \exists x\ \phi(x, y)$ \ &  \ {\tiny \hyperlink{rule:renameBound}{Rename} $z$ by $x$ in \hyperlink{proposition:five!17}{(17)}} \\ 
 & & \qedhere
\end{longtable}
\end{proof}
...
\mbox{}\\
\begin{longtable}[h!]{r@{\extracolsep{\fill}}p{9cm}@{\extracolsep{\fill}}p{4cm}}
\label{proposition:six!1} \hypertarget{proposition:six!1}{\mbox{(1)}}  \ &  \ $\forall x\ \phi(x)\ \rightarrow\ \phi(y)$ \ &  \ {\tiny \hyperlink{rule:addProvenFormula}{Add} \hyperlink{axiom:universalInstantiation}{Axiom~5}} \\ 
\label{proposition:six!2} \hypertarget{proposition:six!2}{\mbox{(2)}}  \ &  \ $\forall x\ \phi(x)\ \rightarrow\ \phi(u)$ \ &  \ {\tiny \hyperlink{rule:replaceFree}{SubstFree} $y$ by $u$ in \hyperlink{proposition:six!1}{(1)}} \\ 
\label{proposition:six!3} \hypertarget{proposition:six!3}{\mbox{(3)}}  \ &  \ $\forall y\ \phi(y)\ \rightarrow\ \phi(u)$ \ &  \ {\tiny \hyperlink{rule:renameBound}{Rename} $x$ by $y$ in \hyperlink{proposition:six!2}{(2)}} \\ 
\label{proposition:six!4} \hypertarget{proposition:six!4}{\mbox{(4)}}  \ &  \ $\forall y\ \phi(z, y)\ \rightarrow\ \phi(z, u)$ \ &  \ {\tiny \hyperlink{rule:replacePred}{SubstPred} $\phi(x)$ by $\phi(z, x)$ in \hyperlink{proposition:six!3}{(3)}} \\ 
\label{proposition:six!5} \hypertarget{proposition:six!5}{\mbox{(5)}}  \ &  \ $\forall x\ \forall y\ \phi(x, y)\ \rightarrow\ \forall y\ \phi(u, y)$ \ &  \ {\tiny \hyperlink{rule:replacePred}{SubstPred} $\phi(x)$ by $\forall y\ \phi(x, y)$ in \hyperlink{proposition:six!2}{(2)}} \\ 
\label{proposition:six!6} \hypertarget{proposition:six!6}{\mbox{(6)}}  \ &  \ $\forall x\ \forall y\ \phi(x, y)\ \rightarrow\ \forall y\ \phi(z, y)$ \ &  \ {\tiny \hyperlink{rule:replaceFree}{SubstFree} $u$ by $z$ in \hyperlink{proposition:six!5}{(5)}} \\ 
\label{proposition:six!7} \hypertarget{proposition:six!7}{\mbox{(7)}}  \ &  \ $(A\ \rightarrow\ B)\ \rightarrow\ ((C\ \rightarrow\ A)\ \rightarrow\ (C\ \rightarrow\ B))$ \ &  \ {\tiny \hyperlink{rule:addProvenFormula}{Add} \hyperlink{axiom:disjunction_addition}{Axiom~4}} \\ 
\label{proposition:six!8} \hypertarget{proposition:six!8}{\mbox{(8)}}  \ &  \ $(\forall y\ \phi(z, y)\ \rightarrow\ B)\ \rightarrow\ ((C\ \rightarrow\ \forall y\ \phi(z, y))\ \rightarrow\ (C\ \rightarrow\ B))$ \ &  \ {\tiny \hyperlink{rule:replacePred}{SubstPred} $A$ by $\forall y\ \phi(z, y)$ in \hyperlink{proposition:six!7}{(7)}} \\ 
...
%% end of chapter MISSING! OTHER: First
