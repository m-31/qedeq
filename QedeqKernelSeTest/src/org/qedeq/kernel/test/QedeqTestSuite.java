/* $Id: QedeqTestSuite.java,v 1.5 2007/02/25 20:04:31 m31 Exp $
 *
...
public class QedeqTestSuite extends TestSuite {
    ...
    static private boolean withTest = true;

    /** Test also tests that start with "pest" instead of "test"? */
    static private boolean withPest = false;
     ...
     * @param   withPest    Execute "pest*" methods.
     */
    public QedeqTestSuite(final Class theClass, boolean withTest, final boolean withPest) {
        setWithTest(withTest);
        setWithPest(withPest);
