...
public class SourcePositionTest extends QedeqTestCase {
    ...
    public void testGetLine() {
        assertEquals(12, object1.getLine());
        assertEquals(12, object2.getLine());
        assertEquals(13, object3.getLine());
        assertEquals(12, object4.getLine());
        assertEquals(13, object5.getLine());
    }
