/* $Id: GenerateXmlTest.java,v 1.2 2008/03/27 05:12:39 m31 Exp $
 *
...
import org.qedeq.kernel.xml.dao.Xml2Xml;
...
public final class GenerateXmlTest extends QedeqTestCase {
    ...
    public void testGeneration() throws Exception {
        ...
        generate(new File("."), "data/qedeq_set_theory_compare.xml", genDir);
        generate(new File("."), "data/qedeq_basic_concept_compare.xml", genDir);
    }
