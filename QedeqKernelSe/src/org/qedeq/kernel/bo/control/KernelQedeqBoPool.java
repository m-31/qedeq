/* $Id: KernelQedeqBoPool.java,v 1.1 2008/03/27 05:16:24 m31 Exp $
 *
...
public class KernelQedeqBoPool {
     ...
     */
    final synchronized KernelQedeqBo getKernelQedeqBo(final ModuleAddress address) {
        if (bos.containsKey(address)) {
            return (KernelQedeqBo) bos.get(address);
        } else {
            final KernelQedeqBo prop = new KernelQedeqBo(address);
