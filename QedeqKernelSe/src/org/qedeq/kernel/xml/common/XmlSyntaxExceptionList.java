...
/**
 * Type save list of {@link org.qedeq.kernel.xml.common.XmlSyntaxException}.
 *
 * FIXME mime 20071124: @deprecated  Move this functionality into SourceFileException List
 * @version $Revision: 1.1 $
 * @author  Michael Meyling
 */
public final class XmlSyntaxExceptionList {
     ...
     */
    public final void add(final XmlSyntaxException e) throws  SAXException {
        if (e == null) {
     ...
     */
    public final XmlSyntaxException get(final int i) {
        return (XmlSyntaxException) exceptions.get(i);
    }
     ...
     */
    public final XmlSyntaxException[] toArray() {
        return (XmlSyntaxException[]) exceptions.toArray(new XmlSyntaxException[0]);
    }
