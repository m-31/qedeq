...
set QEDEQ_CP=config;lib/qedeq_gui_se-@QEDEQ_VERSION@.jar;lib/qedeq_kernel-@QEDEQ_VERSION@.jar;lib/xercesImpl.jar;lib/xml-apis.jar;lib/commons-io-1.4.jar;lib/commons-lang-2.4.jar;lib/commons-logging-1.1.1.jar;lib/commons-httpclient-3.1.jar;lib/commons-codec-1.3.jar;lib/log4j-1.2.14.jar;lib/forms-1.1.0.jar;lib/looks-2.1.4.jar
