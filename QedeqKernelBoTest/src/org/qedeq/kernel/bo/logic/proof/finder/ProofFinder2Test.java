 ...
 */
public class ProofFinder2Test extends QedeqBoTestCase {

    public ProofFinder2Test() {
        super();
    }

    public ProofFinder2Test(final String name) {
        super(name);
    }
    ...
    public void testFind() throws Exception {
        ...
        final ProofFinder finder = new ProofFinderImpl2();
