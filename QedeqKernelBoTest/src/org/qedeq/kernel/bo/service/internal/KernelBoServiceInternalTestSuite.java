 ...
 */
public class KernelBoServiceInternalTestSuite extends QedeqTestSuite {
    ...
    public static Test suite() {
        return new KernelBoServiceInternalTestSuite();
    }

    /**
     * Constructor.
     */
    public KernelBoServiceInternalTestSuite() {
        super();
